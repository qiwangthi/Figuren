public class Cat extends Figuren {
    ...
    public Cat(int factor, int offsetLeft, int maxHeightPanel, int mainBodyWidth, int mainBodyHeight, int legsWidth,
            int legsHeight, int headRadius, int earsHeight, int earsWidth, int tailWidth, int tailHeight) {
